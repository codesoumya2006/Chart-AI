...
export const Minimap: React.FC<MinimapProps> = ({
  ...
  return (
    <div 
      className={`absolute bottom-4 backdrop-blur-sm border rounded-lg shadow-xl z-40 pointer-events-auto transition-colors duration-300 ${
        theme === 'dark'
    ...
    >
      ...
      >
        {/* Background */}
        <rect width={MINIMAP_SIZE} height={MINIMAP_SIZE} fill={theme === 'dark' ? '#18181b' : '#f5f5f5'} rx="8" />
