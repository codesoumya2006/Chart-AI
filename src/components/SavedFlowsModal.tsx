        ...
        {showSaveForm ? (
          <div className="flex-1 overflow-y-auto">
            <div className="space-y-4">
              <div>
                <label htmlFor="flowTitle" className="block text-sm text-zinc-400 mb-2">Title *</label>
                <input
                  id="flowTitle"
                  name="flowTitle"
                  type="text"
              ...
              <div>
                <label htmlFor="flowDescription" className="block text-sm text-zinc-400 mb-2">Description</label>
                <textarea
                  id="flowDescription"
          ...
          <>
            <div className="flex gap-2 mb-4">
              <div className="flex-1 relative">
                ...
                <label htmlFor="searchFlows" className="sr-only">Search flows</label>
                <input
                  id="searchFlows"
                  name="searchFlows"
                  type="text"
